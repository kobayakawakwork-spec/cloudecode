    ...
    >
      ...
      <g transform="translate(54 74)">
        <path
          ...
          fill="#9aa4b2"
        />
        <circle cx="26" cy="16" r="18" fill="#f2c39c" />
        <path
  ...
  return (
    ...
    >
      ...
      <g transform="translate(30 34)">
        ...
        <path d="M4 10 Q4 -8 20 -8 Q36 -8 36 10 Q36 -2 20 -2 Q4 -2 4 10Z" fill="#2c3650" />
      </g>
      ...
      <g transform="translate(100 34)">
        ...
        <path d="M4 10 Q4 -8 20 -8 Q36 -8 36 10 Q36 -2 20 -2 Q4 -2 4 10Z" fill="#0b1220" />
      </g>
    </svg>
  );
}
    ...
    >
      ...
      <g transform="translate(24 78)">
        <path
          ...
          fill="#2451e5"
        />
        <circle cx="24" cy="14" r="18" fill="#f2c39c" />
        <path
